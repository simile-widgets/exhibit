Exhibit.Localization.importLocale("fi", {
    "%general.missingLabel": "puuttuu",
    "%general.missingSortKey": "(puuttuu)",
    "%general.notApplicableSortKey": "(n/a)",
    "%general.itemLinkLabel": "linkki",
    "%general.busyIndicatorMessage": " Hakee...",
    ...
    "%export.exportButtonLabel": "Vie",
    "%export.exportAllButtonLabel": "Vie kaikki",
    "%export.exportDialogBoxCloseButtonLabel" : "Sulje",
    "%export.exportDialogBoxPrompt": "Kopioi tiedot leikep\u00f6yd\u00e4lle (Control-c). Paina ESC sulkeaksesi ikkuna.",
    "%export.focusDialogBoxCloseButtonLabel": "Sulje",
    "%export.rdfXmlExporterLabel": "RDF/XML",
    "%export.smwExporterLabel": "Semanttinen wikitext",
    "%export.exhibitJsonExporterLabel": "Exhibit JSON",
    "%export.tsvExporterLabel": "Tabulaattorierotettu teksti",
    "%export.htmlTableExporterLabel": "HTML-taulu",
    "%export.htmlExporterLabel": "T\u00e4st\u00e4 n\u00e4kym\u00e4st\u00e4 generoitu HTML",
    ...
    "%database.sortLabels.text.ascending": "a - \u00f6",
    "%database.sortLabels.text.descending": "\u00f6 - a",
    "%database.sortLabels.number.ascending": "pienimm\u00e4t ensin",
    "%database.sortLabels.number.descending": "suurimmat ensin",
    "%database.sortLabels.date.ascending": "vanhimmat ensin",
    "%database.sortLabels.date.descending": "uusimmat ensin",
    "%database.sortLabels.boolean.ascending": "ep\u00e4tosi ensin",
    "%database.sortLabels.boolean.descending": "tosi ensin",
    "%database.sortLabels.item.ascending": "a - \u00f6",
    "%database.sortLabels.item.descending": "\u00f6 - a",
    ...
    "%coders.missingCaseLabel": "puuttuu",
    "%coders.othersCaseLabel": "others",
    "%coders.error.configuration": "%1$s: Error processing configuration of coder",

    "%facets.clearSelectionsTooltip": "Poista valinnat",
    "%facets.facetSelectActionTitle": "Valittu %1$s n\u00e4kym\u00e4st\u00e4 %2$s",
    "%facets.facetUnselectActionTitle": "Poistettu valinta %1$s n\u00e4kym\u00e4st\u00e4 %2$s",
    "%facets.facetSelectOnlyActionTitle": "Valittu %1$s n\u00e4kym\u00e4st\u00e4 %2$s",
    "%facets.facetClearSelectionsActionTitle": "Poistettu valinnat n\u00e4kym\u00e4st\u00e4 %1$s",
    "%facets.facetTextSearchActionTitle": "Vapaatekstihaku %1$s",
    "%facets.facetClearTextSearchActionTitle": "Poistettu vapaatekstihaku",
    "%facets.missingThisField": "(puuttuu)",
    "%facets.missingLabel": "puuttuu %1$s",
    "%facets.error.configuration": "%1$s: Error processing configuration of facet",
    "%facets.numeric.rangeShort": "%1$d - %2$d",
    "%facets.numeric.rangeWords": "%1$d - %2$d",
    "%facets.alpha.rangeShort": "%1$s - %2$s",
    "%facets.alpha.rangeWords": "%1$s to %2$s",
    "%facets.hierarchical.othersLabel": "(muut)",
    ...
    "%viewPanel.selectViewActionTitle": "valittu %1$s n\u00e4kym\u00e4",
    ...
    "%ThumbnailView.tooltip": "N\u00e4yt\u00e4 tiedot pikkukuvina",

    "%TabularView.label": "Taulukko",
    "%TabularView.tooltip": "N\u00e4yt\u00e4 taulukkona",
    "%TabularView.columnHeaderSortTooltip": "Lajittele täm\u00e4n sarakkeen mukaan",
    "%TabularView.columnHeaderReSortTooltip": "Lajittele p\u00e4invastaiseen j\u00e4rjestykseen",
    "%TabularView.sortColumnAscending": "Lajittele nousevaan j\u00e4rjestykseen %1$s",
    "%TabularView.sortColumnDescending": "Lajittele laskevaan j\u00e4rjestykseen %1$s",
    "%TabularView.error.configuration": "TabularView: Error processing configuration of tabular view",

    "%orderedViewFrame.removeOrderLabel": "Poista t\u00e4m\u00e4 j\u00e4rjestys",
    "%orderedViewFrame.sortingControlsTemplate": "Lajittele: <span id=\"ordersSpan\"></span>; <a id=\"thenSortByAction\" href=\"#\" class=\"exhibit-action\" title=\"Lajittele lisäksi\">ja...</a>",
    "%orderedViewFrame.formatSortActionTitle": "Lajiteltu %1$s (%2$s)",
    "%orderedViewFrame.formatRemoveOrderActionTitle": "Poistettu järjestys %1$s (%2$s)",
    "%orderedViewFrame.groupedAsSortedOptionLabel": "Ryhmittele",
    "%orderedViewFrame.groupAsSortedActionTitle": "Ryhmittele",
    "%orderedViewFrame.ungroupAsSortedActionTitle": "Poistettu ryhmittely",
    "%orderedViewFrame.showAllActionTitle": "N\u00e4yt\u00e4 kaikki",
    "%orderedViewFrame.dontShowAllActionTitle": "N\u00e4yt\u00e4 ensimmäiset",
    "%orderedViewFrame.formatDontShowAll": "N\u00E4yt\u00E4 %1$d ensimm\u00E4ist\u00E4",
    "%orderedViewFrame.formatShowAll": "N\u00E4yt\u00E4 kaikki %1$d",
    "%orderedViewFrame.pageWindowEllipses": " ... ",
    "%orderedViewFrame.pageSeparator": " &bull; ",
    "%orderedViewFrame.previousPage": "&laquo;&nbsp;Edellinen",
    "%orderedViewFrame.nextPage": "Seuraava&nbsp;&raquo;",
    "%orderedViewFrame.pagingActionTitle": "Sivu %1$d",
    "%orderedViewFrame.pagingLinkTooltip": "Mene sivulle %1$d",
    ...
    "%widget.bookmark.tooltip": "Luo kirjanmerkki",

    "%widget.collectionSummary.resetFiltersLabel": "Poista kaikki rajaukset",
    "%widget.collectionSummary.resetFiltersTooltip": "N\u00e4ytä kaikki",
    "%widget.collectionSummary.resetActionTitle": "Poistettu kaikki rajaukset",
    "%widget.collectionSummary.allResultsTemplate": "<span class=\"%1$s\" id=\"resultDescription\"></span>",
    "%widget.collectionSummary.noResultsTemplate": "<span class=\"%1$s\"><span class=\"%2$s\">0</span> hakutulosta</span> (<span id=\"resetActionLink\"></span>)",
    "%widget.collectionSummary.filteredResultsTemplate": "<span class=\"%1$s\" id=\"resultDescription\"></span> rajattu <span id=\"originalCountSpan\">0</span>:sta (<span id=\"resetActionLink\"></span>)",

    "%formatter.listSeparator": ", ",
    "%formatter.listLastSeparator": ", ",
    "%formatter.listPairSeparator": ", ",
    "%formatter.textEllipsis": "%1$s...",
    "%formatter.booleanTrue": "true",
    "%formatter.booleanFalse": "false",
    "%formatter.currencySymbol": "$",
    "%formatter.currencySymbolPlacement": "last", // "first", "last", "after-sign"
