Exhibit.Localization.importLocale("fi", {
    ...
    "%export.exportDialogBoxPrompt": "Kopioi tiedot leikepöydälle (Control-c). Paina ESC sulkeaksesi ikkunan.",
    ...
    "%facets.facetClearSelectionsActionTitle": "Poista valinnat näkymästä %1$s",
    "%facets.facetTextSearchActionTitle": "Vapaatekstihaku %1$s",
    "%facets.facetClearTextSearchActionTitle": "Tyhjennä vapaatekstihaku",
    ...
    "%orderedViewFrame.ungroupAsSortedActionTitle": "Poista ryhmittely",
    ...
    "%widget.collectionSummary.resetActionTitle": "Poista kaikki rajaukset",
