Exhibit.Localization.importLocale("en", {
    ...
    "%import.error.couldNotLoad": "Could not load data from %1$s into the database",
    "%import.error.couldNotParse": "Could not parse %1$s",
    "%import.error.missingOrFilesystem": "Failed to access %1$s, possibly because the file is missing or because you are accessing your files via filesystem instead of a webserver while using Chrome or IE.  Use a different browser or move your files onto a webserver.",
    "%import.error.httpError": "Failed to access %1$s (HTTP %2$d)",
    "%import.error.failedAccess": "Failed to access %1$s%2$s",
    "%import.error.failedAccessHttpStatus": " (HTTP %1$d)",
    ...
    "%facets.error.missingLabel": "missing %1$s",
    ...
    "%widget.collectionSummary.resultsLabel": "results",
    "%widget.collectionSummary.filteredFromLabel": "filtered from",
    "%widget.collectionSummary.originallyLabel": "originally",
